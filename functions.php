...
function aca_register_styles() {
	...
	wp_register_style('splide-style-core', get_stylesheet_directory_uri() . '/inc/splide/splide-core.min.css', [], $splide_version);
	wp_register_style('splide-style-default', get_stylesheet_directory_uri() . '/inc/splide/splide.min.css', [], $splide_version);
	wp_register_style('splide-style-video', get_template_directory_uri() . '/inc/splide/extensions/video/splide-extension-video.min.css', [], $splide_version);

	wp_enqueue_style('aca-style');
	wp_enqueue_style('aca-style-min');
	wp_enqueue_style('fontawesome-style');
	wp_enqueue_style('aos-style');
	// wp_enqueue_style('splide-style-core');
	wp_enqueue_style('splide-style-default');
	wp_enqueue_style('splide-style-video');
}
...
function aca_register_scripts(){
	...
	wp_register_script( 'splide-script', get_stylesheet_directory_uri() . '/inc/splide/splide.min.js', [], $splide_version );
	wp_register_script( 'splide-ext-video', get_template_directory_uri() . '/inc/splide/extensions/video/splide-extension-video.min.js', ['splide-script'], $splide_version);
	wp_register_script( 'splide', get_stylesheet_directory_uri() . '/assets/js/splide-min.js', ['splide-script', 'splide-ext-video'], $theme_version, true);
	...
	wp_enqueue_script('splide-ext-video');
